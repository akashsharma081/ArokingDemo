...
function About() {
	...
	<header id="fh5co-header" class="fh5co-cover fh5co-cover-sm" role="banner" style={{ backgroundImage: "url(/images/2.jpg)" }}>
		...
		<div class="container">
			<div class="about-content">
				<div class="row animate-box">
					...
					<div class="col-md-6">
						<img class="img-responsive" src="images/4.png" alt="about"/>
					</div>
				</div>
			</div>
			<div class="row animate-box">
